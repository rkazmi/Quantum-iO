...
In the previous section we showed that we can obfuscate any $1$-qubit unitary circuit via gate teleportation and quantum secure iO. Can we not construct a $Qi\mathcal{O}$ for any $n$-qubit unitary circuit using  the same methodology. Unfortunately, for any circuit $n>1,$ the complexity of 
