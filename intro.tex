...
\Anne{I am currently thinking that we could let the quantum iO output a pure state, e.g. $\ket{\phi}$, instead of a mixed state $\rho$. This could simplify things later. But I don't know if this is general enough.}
