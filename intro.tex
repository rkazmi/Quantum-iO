...
The quantum obfuscation was first studied in \cite{}, where a new notion called  
...
The quantum obfuscation is studied more rigorously in \cite{}, where the following notions of quantum obfuscation are defined.
\begin{enumerate}
