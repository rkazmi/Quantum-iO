...
We note that, also for other quantum cryptographic primitives, the $\tgate$ is often the bottleneck (somewhat skin to a \emph{multiplication} in the classical case. This has been observed, \emph{e.g.}, in the context of \emph{homomorphic quantum encryption} \cite{BJ15}, instantaneous quantum computation \cite{TODO} and also.... TODO 
...
\anote{TODO: emphasize other work where a limited number of $T$-gates was tolerated, e.g. \cite{BJ15}., and also how the $T$-gate is often seen as the bottle-neck, e.g. in fault-tolerant quantum computing, and state as open problem the general case.  }



\subsection{More on Related Work}
\label{sec:obf-quantum}
Quantum obfuscation was first studied in \cite{AJJ14}, where a new notion called
