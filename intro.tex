...
\paragraph{Obfuscating Beyond Cliffords} Next, in our main result \Cref{QiO:Clifford+T:family}, we generalize the gate-teleportation scheme for Clifford circuits, and show an $Qi\mathcal{O}$ obfuscator for all quantum circuits where the number of non-Clifford ($T$) gates is at most logarithmic in the circuit size. 
